...
enum class ToolbarKey {
    ...
    PAGE_UP, PAGE_DOWN, FULL_LEFT, FULL_RIGHT, PAGE_START, PAGE_END, AI_TOOLS, GIFS, STICKERS, RESIZE, TEXT_EDIT, FLOATING
}
...
val defaultToolbarPref by lazy {
    // Individual text-editing actions (undo/redo/select/copy/paste/arrows) are grouped under the
    // single TEXT_EDIT key by default, like Gboard's "edit text" bubble, to avoid cluttering the
    // toolbar/access menu. They remain available individually for anyone who wants to re-pin them.
    val default = listOf(SETTINGS, VOICE, CLIPBOARD, TEXT_EDIT, RESIZE)
