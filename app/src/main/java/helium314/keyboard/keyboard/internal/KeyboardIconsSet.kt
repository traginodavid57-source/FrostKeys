...
//            NAME_PREVIOUS_KEY to                null,
            ...
            ToolbarKey.entries.forEach {
                put(it.name.lowercase(Locale.US), when (it) {
                    ...
                    ToolbarKey.TEXT_EDIT -> R.drawable.ic_edit
                    ToolbarKey.FLOATING -> R.drawable.sym_keyboard_start_floating_holo
                })
            }
        } }
...
//            NAME_SPACE_KEY to                   null,
            ...
            ToolbarKey.entries.forEach {
                put(it.name.lowercase(Locale.US), when (it) {
                    ...
                    ToolbarKey.RESIZE -> R.drawable.ic_resize_vertical_rounded
                    ToolbarKey.TEXT_EDIT -> R.drawable.ic_edit
                    ToolbarKey.FLOATING -> R.drawable.sym_keyboard_start_floating_lxx
                })
            }
        } }
...
//            NAME_SPACE_KEY to                   null,
            ...
            ToolbarKey.entries.forEach {
                put(it.name.lowercase(Locale.US), when (it) {
                    ...
                    ToolbarKey.RESIZE -> R.drawable.ic_resize_vertical_rounded
                    ToolbarKey.TEXT_EDIT -> R.drawable.ic_edit
                    ToolbarKey.FLOATING -> R.drawable.ic_keyboard_floating_rounded
                })
            }
        } }
